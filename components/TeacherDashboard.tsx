                ...
                return (
                  <div key={test.id} className="flex items-center gap-2">
                    <button
                      ...
                      className="flex-grow p-4 bg-slate-50 rounded-2xl border border-transparent hover:border-indigo-200 hover:bg-indigo-50 transition-all flex items-center justify-between text-left group"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl text-slate-300 hover:text-rose-500 hover:bg-rose-50 transition-all flex-shrink-0"
                      title="삭제"
                    >
